...
<main class="container">
    ...
    <?php if ($notice): ?><div class="alert alert-success"><?php echo tf_h($notice); ?></div><?php endif; ?>
    <?php if ($errors): ?><div class="alert alert-error"><ul><?php foreach ($errors as $error): ?><li><?php echo tf_h($error); ?></li><?php endforeach; ?></ul></div><?php endif; ?>
